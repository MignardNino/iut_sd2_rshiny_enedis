...
```{r correlation_plot, echo=FALSE,error=FALSE, warning=FALSE, message=FALSE}
...
```{r leaflet_map, echo=FALSE,error=FALSE, warning=FALSE, message=FALSE}
...
```{r renovation_analysis, echo=FALSE,error=FALSE, warning=FALSE, message=FALSE}
...
```{r cost_distribution, echo=FALSE,error=FALSE, warning=FALSE, message=FALSE}
...
ggplot(merged_data, aes(x = Logement, y = Coût_chauffage, fill = Logement)) +
  ...
  coord_cartesian(ylim = c(0, 5000)) +  # Ajuster l'axe des y pour mieux visualiser
